...
- (BOOL)isEqualToStringWithCaseInsensitive:(NSString *)otherString {
 ...
 */
- (NSString *)mlb_stringByAddingFatWhitespace {
	if (!self || [@"" isEqualToString:self] || (NSNull *)self == [NSNull null]) {
		return @"";
	}
